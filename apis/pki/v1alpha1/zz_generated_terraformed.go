...
func (tr *SecretBackendConfigUrls) GetObservation() (map[string]interface{}, error) {
...
func (tr *SecretBackendConfigUrls) SetObservation(obs map[string]interface{}) error {
...
func (tr *SecretBackendConfigUrls) GetParameters() (map[string]interface{}, error) {
...
func (tr *SecretBackendConfigUrls) SetParameters(params map[string]interface{}) error {
...
func (tr *SecretBackendRole) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *SecretBackendRole) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *SecretBackendRole) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *SecretBackendRole) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
func (tr *SecretBackendRootCert) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *SecretBackendRootCert) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *SecretBackendRootCert) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *SecretBackendRootCert) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
